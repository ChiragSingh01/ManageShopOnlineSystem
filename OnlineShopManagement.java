...
public class OnlineShopManagement {
     ...
     String getCondition(List <String> Tables){
    ...
    private StringBuilder getUsername (String FirstName, String LastName){
        Random rnd = new Random();
        int Bond = 99,i=0;
    ...
    private void insertTable(String ID, String... Values) {
        try {
            Connection con = makeConnection();
    ...
    private String getPrimeKey(String TableName) {
        try {
            Connection con = makeConnection();
            if (con != null) {
    ...
    public void updateValues(String TableName, String... Column_Values) {
    ...
    public void Alter(String TableName, String ColumnName) {
        try {
            Connection con = makeConnection();
            if (con != null) {
                Statement st = con.createStatement();
    ...
    public void Alter_column(String Tablename, String ColumnName) {
        try {
            Connection con = makeConnection();
            if (con != null) {
                Statement st = con.createStatement();
    ...
    public void Alter_rename(String Tablename, String Oldcolumn, String Newcolumn) {
        try {
            Connection con = makeConnection();
            if (con != null) {
                Statement st = con.createStatement();
    ...
    public void Display (String TableName, String ...Column) {
        try{
            Connection con = makeConnection();
            if (con != null) {
                Statement st = con.createStatement();
    ...
    public void Display_Condition (String TableName, String Column_Name, String Condition, String ...Column) {
        try{
            Connection con = makeConnection();
            if (con != null) {
                Statement st = con.createStatement();
    ...
    private boolean Check (String ...Detail){
        try {
            Connection con = makeConnection();
            if (con != null) {
                Statement st = con.createStatement();
                String Query = String.format("select * from CustomerAccounts where AccEmail = %s",Detail[0]);
                ResultSet rs = st.executeQuery(Query);
                ...
                if(Detail.length==1) {
                    if (list.contains(Detail[0]))
                        return true;
                } else if (Detail.length==2) {
                    if (list.contains(Detail[0]) && list.contains(Detail[1]))
                        return true;
                }
            } else
                System.out.println("Connection doesn't established");
        ...
        if(Check(Mail)) {
            ...
            if(Check(Mail, Pass)) {
                ...
                try{
                    assert con != null;
                    Statement st = con.createStatement();
                    ResultSet rs = st.executeQuery(String.format("select * from customeraccounts where AccEmail = '%s'",Mail));
                    rs.next();
    ...
    public void order (String CusID) {
    ...
    public void FeedBackNotify (String CusID) {
        Connection con = makeConnection();
        if(con != null){
            try{
                Statement st = con.createStatement();
